...
const anthem = {
  ...
  lines: [
    ...
    "A Fountain of knowledge and character",
    "In full stature",
...
export default function SchoolAnthem() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, #040e26 0%, #071d4a 45%, #0a2a6e 100%)",
      }}
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(14,83,156,0.35) 0%, transparent 70%)",
          }}
        />
        <div
      ...
      <div className="container-custom relative z-10">
        ...
        <div ref={headRef} className="text-center mb-14">
          ...
          >
            These words echo through our halls — a declaration of purpose,
            identity, and excellence that every Pathfinder student carries in
            their heart.
          </motion.p>
